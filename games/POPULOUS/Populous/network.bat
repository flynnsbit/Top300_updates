...
echo Choose F3 - Custom
echo Type in your Diety name and anything for the shield copy protection
echo Click the World Icon to open Game Setup
echo Select Two Players
echo Select I am Good or I am Evil
