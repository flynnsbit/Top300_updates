...
echo In the main menu choose the network statue on the desk
echo Select the name of your avatar
echo When other players are detected, they will be added and the game will start
echo.
jchoice
cd carpet
carpet -network
